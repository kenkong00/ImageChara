...
input_file = r"g:\AI code\trae\comfyui出图查看器\json\黑兽9_prompts_export_cleaned_final.json"
output_file = r"g:\AI code\trae\comfyui出图查看器\json\黑兽9_prompts_export_cleaned_final_翻译.json"
